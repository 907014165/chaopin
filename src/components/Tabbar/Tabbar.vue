<template>
  <div class="tabbar">
    <van-tabbar v-model="active" active-color="#f23030">
      ...
      <van-tabbar-item icon="apps-o" to="/category" :replace="true">分类</van-tabbar-item>
      <van-tabbar-item icon="shopping-cart-o" to="/shopcart" :info="shopCartListItemNum" :replace="true">购物车</van-tabbar-item>
      <van-tabbar-item icon="manager" to="/user" :replace="true">我的</van-tabbar-item>
    </van-tabbar>
  </div>
</template>
<script>
